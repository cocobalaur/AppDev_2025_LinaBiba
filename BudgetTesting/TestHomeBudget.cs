...
namespace BudgetCodeTests
{
    ...
    public class TestHomeBudget
    {
        ...
        [Fact]
        public void HomeBudget_ShouldThrowException_WhenFileIsEmpty()
        {
            Assert.Throws<ArgumentException>(() => new HomeBudget(" ", true));
        }

        // ========================================================================

        [Fact]
        public void HomeBudget_ShouldCreateNewDatabase_WhenFileDoesNotExist()
        {
            string testFile = "testBudgetdb.db";
            if (File.Exists(testFile)) File.Delete(testFile);

            var budget = new HomeBudget(testFile, false);
        ...
        [Fact]
        public void HomeBudget_ShouldLoadExistingDatabase_WhenFileExists()
        {
            string testFile = "newdb.db"; //existing file
